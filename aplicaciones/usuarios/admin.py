...
admin.site.site_header = 'HICAST'
admin.site.index_title = 'Sistema de HICAST'
admin.site.site_title = 'HICAST'
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        #Aqui es para editar
        ("Informacion Esencial", {'fields': ('username','nombres','apellidos','email','rut','imagenPerfil','nacionalidad', 'password')}),
        ("Permisologia", {
            'classes': ('wide',),
    ...
    add_fieldsets = (
        ("Informacion Obligatoria", {
            'classes': ('wide',),
            'fields': ('username','nombres','apellidos','email','imagenPerfil','nacionalidad', 'password1', 'password2'),
        }),
        ("Informacion Importante", {
            'classes': ('wide',),
            'fields': ('activo', 'is_superuser','admin', 'rut','telefono'),
    ...
    list_display = ('id','username','rut', 'email','is_superuser','admin','nacionalidad','activo','fecha_creacion','ultimo_ingreso')
    #list_display = ('username', 'email','is_superuser','admin','rol','plan_elegido')
    list_filter = ('username','email','activo','nacionalidad')
